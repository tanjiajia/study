		...
		$.get('json/shop.json').done(function (data) {  
			...
			$.each(data,function(i,value){
		    	clone = goodsSortList01.children("[data-type=list].dn").clone(true).removeClass("dn");
		      	...
		      	clone.find(".number span").text(i+1);
		      	clone.find(".list_02").text(value.name);
		      	clone.find("[data-type=vallist01]").text(value.option01);
		      	clone.find("[data-type=vallist02]").text(value.option02);
		      	clone.find("[data-type=vallist03]").text(value.option03);
		      	clone.find("[data-type=vallist04]").text(value.option04);
